  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      <div className="mb-4 sm:mb-6">
        ...
        <p className="text-sm sm:text-base text-gray-600">View and manage all your time entry notes in one place</p>
      </div>
      ...
      {entriesWithNotes.length === 0 ? (
        <Card>
          <CardContent className="text-center py-8 sm:py-12 px-4">
            ...
            <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-2">No notes yet</h3>
