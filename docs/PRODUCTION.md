...
PADDLE_PRO_PRICE_ID=...
PADDLE_ULTIMATE_PRICE_ID=...
PADDLE_PRO_ANNUAL_PRICE_ID=...
PADDLE_ULTIMATE_ANNUAL_PRICE_ID=...
OPENAI_API_KEY=...
...
`PADDLE_LIVE_PRO_PRICE_ID`, `PADDLE_LIVE_ULTIMATE_PRICE_ID`, `PADDLE_LIVE_PRO_ANNUAL_PRICE_ID`, and
`PADDLE_LIVE_ULTIMATE_ANNUAL_PRICE_ID`. These are staging slots only. The application
